...
############################
# Build entservices-deviceinfo
echo "buliding entservices-deviceinfo"

cd ${GITHUB_WORKSPACE}
cmake -G Ninja -S "$GITHUB_WORKSPACE" -B build/entservices-deviceinfo \
-DUSE_THUNDER_R4=ON \
...
cmake --build build/entservices-deviceinfo --target install
echo "======================================================================================"
exit 0
