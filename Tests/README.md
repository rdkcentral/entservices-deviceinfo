...
example: git clone https://github.com/rdkcentral/entservices-deviceinfo.git

2. switch to entservices-<repo-name> directory
example: cd entservices-deviceinfo
...
uses: rdkcentral/entservices-deviceinfo/.github/workflows/L1-tests.yml@topic/method_1 /* tf-trigger.yml */

b/ changes in both testframework repo and invidual repo:
Changes mentioned in step (a) above + "Checkout entservices-deviceinfo-testframework" job in individual repo yml file, ref field to point your deviceinfo current working branch.
example:
ref: topic/method_1 /* Checkout entservices-testframework job */
ref: topic/method_1 /* Checkout entservices-deviceinfo-testframework job */
uses: rdkcentral/entservices-deviceinfo/.github/workflows/L1-tests.yml@topic/method_1 /* tf-trigger.yml */
